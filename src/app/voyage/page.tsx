    ...
    <main className="flex-1">
      ...
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-3xl px-6 text-center text-cream">
          ...
          <motion.div
            ...
            className="mt-10"
          >
            <Link href="/reservation" className="btn-gold inline-block rounded-full px-9 py-4 text-base">
              {t("hero.cta")}
            </Link>
          </motion.div>
        </div>
        ...
        <div className="absolute bottom-8 z-10 w-full">
          ...
          <Countdown target={EVENT.tripStartDate + "T10:00:00+02:00"} />
        </div>
      </section>
      ...
      <section className="bg-cream py-24">
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          <Link href="/reservation" className="btn-gold mt-12 inline-block rounded-full px-9 py-4">
            {t("hero.cta")}
          </Link>
        </div>
      </section>
